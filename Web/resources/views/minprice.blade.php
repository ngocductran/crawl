...
<div>
      <?php
        ...
        $key =  $row['txtsearch'];
        $query2 = "SELECT * FROM product WHERE (ten like '$key%') ORDER BY gia ASC  limit 4";
        $sql2 = mysqli_query($conn, $query2);
        $num = mysqli_num_rows($sql2);

                            /* SHOPPE*/
          $conn5=mysqli_connect("localhost","root","","tiki3") or die("Lỗi");
          mysqli_set_charset($conn5, "utf8");
          $query5 = "SELECT DISTINCT(a.ten),SUBSTR(price, 1, LENGTH(price) - 5) as price , SUBSTR(ten, 1, LENGTH(ten) - 1) as ten, a.image,a.idshop,a.itemid,a.view_count, SUBSTR( price_max_before_discount, 1, LENGTH( price_max_before_discount) - 5) as price_max_before_discount, historical_sold FROM shoppe a WHERE image IS NOT  NULL  and  a.ten like'$key%'  ORDER BY price asc  limit 4";
          ...
          $num5 = mysqli_num_rows($sql5);
            ...
            $querysendo = "SELECT * FROM sendo WHERE (ten like '$key%') ORDER BY  price ASC limit 4 ";
     ...
     <h3 style=" font-weight:bold;color: #FE9A2E"> Từ khóa tìm kiếm : <?php echo $row['txtsearch']; ?></h3>
         <?php  
              if ($num > 0) {
                      ...
                      {
                         ?>
                  <div  style="float:right" class="col-lg-3 col-md-12" >
                  ...
                  <div style="color: rgb(255 193 32); font-size: 15px; ">
                      ...
                      <div><b style="font-size: 15px; font-weight: bold">Giá: <?php echo number_format($row["gia"],2,",",".");?></b>&ensp;<del style="font-size: 15px;"><?php echo ($row["giadiscount"]. ' đ');?></del>
                      </div>
                    </div>
                      <?php  }}?> 
              <!--  shoppemin -->
              ...
              if ($num5 > 0) {
                      ...
                      {
                          ?>
                    <div  style="float:left;" class="col-lg-3 col-md-6" >
 ...
 <!-- sendo -->
              ...
              if ($numsendo > 0) {
                      ...
                      {
                          ?>
                    <div  style="float:left;margin-bottom:15px" class="col-lg-3 col-md-6" >
                    <img style="width: 50px;height: 50px" src="https://cdn.chanhtuoi.com/uploads/2020/02/w400/sendo.png.webp"> 
                     ...
                     <div style="color: rgb(255 193 32); font-size: 15px; ">
                      ...
                      <div><b style="font-size: 15px">Giá: <?php echo number_format($row["price_max"],2,",",".");?></b>&ensp;<del style="font-size: 15px;"><?php echo ($row["price"]. ' đ');?></del></div>
                  </div>
                      <?php  
                      }
                  } 
